      ...
      <div className={Style.flipkartBox}>
        <div className={Style.flipkartBox_one}>
          ...
          <div className={Style.textInputDIv} >
            <TextField id="standard-basic" style={{width:'100%'}} label="Name" value={getUserName} onChange={(e)=>UserNameInput(e)} variant="standard" />
          </div>
          <div className={Style.textInputDIv}>
            <TextField
              id="standard-basic"
          ...
          <div>
          <button className={`${Style.custombtn} ${Style.btn2}`}>Login</button>
          </div>
          <div>
