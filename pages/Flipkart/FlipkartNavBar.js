...
function FlipkartNavBar() {
    return (
        <>
         <nav class="navbar navbar-expand-lg bg-body-tertiary" style={{ backgroundColor: '#2874f0', color: 'white' }}>
    <div class="container-fluid">
        ...
        <button class={`${Style.custombtn} ${Style.btn12}`}><span>Click!</span><span><i class="fa fa-cloud-download" aria-hidden="true"></i>Read More</span></button>
    </div>
</nav>
