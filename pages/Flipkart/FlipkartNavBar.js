        ...
        <>
            <nav className="navbar navbar-expand-lg bg-body-tertiary" style={{ backgroundColor: '#2874f0', color: 'white' }}>
                <div className="container-fluid">
                    <Link className="navbar-brand" href="/Flipkart/MainPage" style={{ color: 'white' }}>Abhijeet Kumar</Link>
                    ...
                    <button className={`${Style.custombtn} ${Style.btn12}`} onClick={() => handleDownload()}><span>Download!</span><span><i className="fa fa-cloud-download" aria-hidden="true"></i>Resume</span></button>
                </div>
            </nav>
